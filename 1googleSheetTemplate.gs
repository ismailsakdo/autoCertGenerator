function onFormSubmit(e) {
  ...
  var templateFileId = '1GD-HgPRDuVG0-XXXXX'; // Replace with the template file ID from your Google Drive
  var folderId = '1y7fCiAFAtvtghHDXXXXXX'; // Replace with the destination folder ID in your Google Drive
